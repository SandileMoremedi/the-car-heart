const Policy = () => {
  return (
    <div className="policy-and-terms">
      <h1>The Car Heart Privacy Policies</h1>
      <p>
        Privacy Policy Template for a Basic Website with User-Generated Content
      </p>
      <p>
        The Car Heart (the “Platform”) is committed to maintaining robust
        ...
        decisions when using our Service. For purposes of this Agreement, “Site”
        refers to the Company&apos;s website, which can be accessed at
        https://thecarheart.vercel.app “Service” refers to the Company&apos;s
        services accessed via the Site, in which users can update, create, read
        and delete blogs. The terms “we,” “us,” and “our” refer to the Company.
        ...
        (found here: https://thecarheart.vercel.app/terms) and you consent to
      ...
      <p>
        ...
        Information includes your email [insert specifically what personal
        information your website collects, i.e. address, date of birth, marital
        status, contact information, etc.], which you submit to us through the
      ...
      <p>
        ...
        thereafter, you [do/do not] need to submit further Personal Information
        [,which may include: list Personal Information collected]. However, in
        ...
        individual and aggregate basis. For example, the Company may use cookies
        to collect the following information: · [list typical things you may
        want to track] The Company may use both persistent and session cookies;
        persistent cookies remain on your computer after you close your session
        and until you delete them, while session cookies expire when you close
      ...
      <p>
        ...
        promotional preferences you indicate by either unsubscribing or opting
        out in the [location of opt-out page] of the Site, we may continue to
